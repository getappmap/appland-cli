...
like. The resulting scenarios can be quite large and noisy. The presence of calls to many
...
of the [AppLand command line](https://github.com/applandinc/appland-cli/releases)
...
recordings will make the scenarios easier to understand, without eliminating any
